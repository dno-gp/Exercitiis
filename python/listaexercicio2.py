...
def maior_numero():
    ...
    if num1 > num2:
        ...
        print(f"Os números informados são iguais. {num1}")
    else:
...
def positivo_negativo():
    ...
    if numero > 0:
        print(f"O valor informado é positivo: {numero}")
    elif numero == 0:
        print(f"O valor informado é neutro: {numero}.")
    else:
        print(f"O valor informado é negativo: {numero}")
...
def genero():
    sexo = input("Informe um gênero (M ou F): ")
    
    if (sexo == "M") or (sexo == "m") or (sexo == "masculino") or (sexo == "Masculino"):
        print("O gênero informado é Maculino.")
    elif (sexo == "F") or (sexo == "f") or (sexo == "feminico") or (sexo == "Feminico"):
        print("O gênero informado é Feminino.")
    else:
        print("Tente novamente. Informe M ou F.")
